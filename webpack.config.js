    ...
    defaultsDeep({}, base, {
        ...
        plugins: base.plugins.concat([
            ...
            new HtmlWebpackPlugin({
                ...
                template: 'src/playground/index.ejs',
                filename: 'index.html',
                title: 'GlowingCrown - A mod of PenguinMod',
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['fullscreen'],
            ...
            new HtmlWebpackPlugin({
                ...
                template: 'src/playground/index.ejs',
                filename: 'embed.html',
                title: 'Embedded Project - GlowingCrown',
                noTheme: true,
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                ...
                title: 'Addon Settings - GlowingCrown',
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['credits'],
